...
enum GenerateSharedTestTargetMapperError: Error {
...
public final class GenerateSharedTestTargetMapper {
    ...
    private func prepareHost(
        for sharedTarget: SharedTestTarget,
        workspace: inout WorkspaceWithProjects,
        sideTable: inout WorkspaceSideTable,
        installIdx: Int
    ) throws -> [Int] {
